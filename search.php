...
<body>
    ...
    <button type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
        ...
        <div class="usercart">
            ...
            <div class="usersec">
                <a href="login.php"><img src="images/account.png" style="width:25px;height:25px;"></a> <span style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif ;cursor: pointer;">LOGIN</span>

            </div>
            <div class="usersignup">
                <a href="account.php"><button style="background: #bd8d54;border: 2px solid burlywood;padding: 5px 10px;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;cursor: pointer;font-weight: bold;">SIGN UP</button></a>
            </div>
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<img src="' . $row['image_url'] . '" alt="' . htmlspecialchars($row['name']) . '" width="100" height="100">';
